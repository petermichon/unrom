...
| AfterlifeOS      | AOSP | ✅ Active      | ✅ GitHub     | Single devices.json file with 20+ devices across Asus, Google, Itel, Motorola, POCO, Realme, Xiaomi; on Android 16 |
...
| Kenvyra          | AOSP | ⚠️ Unclear     | ✅ GitHub     | Device data in Markdown files with YAML frontmatter; 4 devices (Xiaomi 12, Mi 9T/K20, 11 Lite NE, Note 10 Pro)     |
...
| VoltageOS          | AOSP | ✅ Active       | ⚠️ GitHub     | Text file with codenames only, no device names; requires codename-to-name mapping (20+ devices on Android 16) |
